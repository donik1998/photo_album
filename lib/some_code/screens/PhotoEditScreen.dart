...
import 'package:photo_album/some_code/components/BlurSelectorBottomSheet.dart';
import 'package:photo_album/some_code/components/BottomBarItemWidget.dart';
import 'package:photo_album/some_code/components/ColorSelectorBottomSheet.dart';
import 'package:photo_album/some_code/components/EmojiPickerBottomSheet.dart';
import 'package:photo_album/some_code/components/FilterSelectionWidget.dart';
import 'package:photo_album/some_code/components/FrameSelectionWidget.dart';
import 'package:photo_album/some_code/components/ImageFilterWidget.dart';
import 'package:photo_album/some_code/components/SignatureWidget.dart';
import 'package:photo_album/some_code/components/StackedWidgetComponent.dart';
import 'package:photo_album/some_code/components/StickerPickerBottomSheet.dart';
import 'package:photo_album/some_code/components/TextEditorDialog.dart';
import 'package:photo_album/some_code/models/ColorFilterModel.dart';
import 'package:photo_album/some_code/models/StackedWidgetModel.dart';
import 'package:photo_album/some_code/screens/HomeScreen.dart';
import 'package:photo_album/some_code/services/FileService.dart';
import 'package:photo_album/some_code/utils/Colors.dart';
import 'package:photo_album/some_code/utils/Constants.dart';
import 'package:photo_album/some_code/utils/SignatureLibWidget.dart';
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            16.width,
                            Text('Save', style: boldTextStyle(color: colorPrimary))
                                      ...
                                      children: [
                                        ...
                                        if (filter != null && filter!.color != null)
                                          Container(
                                            ...
                                            LinearGradient(
                                                colors: filter!.color!, begin: Alignment.topLeft, end: Alignment.bottomRight),
                    ...
                    child: Stack(
                      ...
                      children: [
                        ListView(
                          ...
                          children: [
                            BottomBarItemWidget(
                                title: 'Eraser', icons: Icon(FontAwesomeIcons.eraser).icon, onTap: () => onEraserClick()),
                            BottomBarItemWidget(
                                title: 'Text', icons: Icon(Icons.text_fields_rounded).icon, onTap: () => onTextClick()),
                            BottomBarItemWidget(
                                title: 'Neon', icons: Icon(Icons.text_fields_rounded).icon, onTap: () => onNeonLightClick()),
                            ...
                            BottomBarItemWidget(
                                title: 'Hue', icons: Icon(Icons.brightness_medium_sharp).icon, onTap: () => onHueSliderClick()),
                            BottomBarItemWidget(
                                title: 'Blur', icons: Icon(MaterialCommunityIcons.blur).icon, onTap: () => onBlurClick()),

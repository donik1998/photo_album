...
class _TrimVideoScreenState extends State<TrimVideoScreen> {
  ...
  Future<void> saveVideo() async {
    ...
    setState(() {});
    await trimmer.saveTrimmedVideo(startValue: startValue, endValue: endValue, onSave: (String? outputPath) async {
    ...
    return Scaffold(
      appBar: appBarWidget(
        ...
        actions: [
          TextButton(
            onPressed: () => saveVideo(),
            child: Text('Save', style: boldTextStyle(color: colorPrimary, size: 18))

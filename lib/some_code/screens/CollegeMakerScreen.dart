...
import 'package:photo_album/some_code/components/CollegeMakerLayoutWidget.dart';
import 'package:photo_album/some_code/components/ColorSelectorBottomSheet.dart';
import 'package:photo_album/some_code/models/CollegeMakerModel.dart';
...
import 'package:photo_album/some_code/utils/DataProvider.dart';
              ...
              Screenshot(
                ...
                child: widget.isAutomatic!
                    ? CollegeMakerLayoutWidget(
                        columnCountList: getCollegeMakerList()[collegeItemIndex]
                            .listCount![Random().nextInt(getCollegeMakerList()[collegeItemIndex].listCount!.length)],

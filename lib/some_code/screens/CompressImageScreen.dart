...
class CompressImageScreenState extends State<CompressImageScreen> {
  ...
  Future<void> compressFile() async {
    compressedFile =
        await getCompressedFile(originalFile, await getFileSavePathWithName(), onDone: (aOriginalFileSize, aCompressFileSize) {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  8.height,
                  compressedFile != null
                      ? Text("You saved: ${originalFileSize - compressFileSize} kb", style: boldTextStyle(color: Color(0xFF00A508)))
                      : SizedBox(),
                ],
              ),
            ],
